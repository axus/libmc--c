...
namespace mc__ {
    ...
    namespace Tex {
        ...
        enum Terrain_t {
            ...
            Dispenser,FireTex2,
            Sponge=48, Glass, DiamondOre, RedOre, Leaf, Leaf1, DeadBush=55,
            DeadTree,
            ...
            SandStone_Top=176, Wool_Blue, Wool_LightBlue, Track_On, None1,None2,
        ...
        enum Item_t {
            ...
            I_Paper, I_Book, I_Map, I_WoodSword=64, I_StoneSword, I_IronSword,
