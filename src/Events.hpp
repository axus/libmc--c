    ...
    class Events {
        public:
            ...
            enum type_t {
                ...
                GAME_MOB_SPAWN=          0x18,
                GAME_ENT_PAINTING=       0x19,
                GAME_ADD_EXP_ORB=        0x1A,
                ...
                GAME_ENT_METADATA=       0x28,
                GAME_ENT_EFFECT=         0x29,
                GAME_ENT_EFFECT_END=     0x2A,
                GAME_PLAYER_EXP=         0x2B,
                GAME_PRECHUNK=           0x32,
                GAME_MAPCHUNK=           0x33,
                GAME_MULTI_BLOCK_CHANGE= 0x34,
                GAME_BLOCK_CHANGE=       0x35,
                GAME_BLOCK_ACTION=       0x36,
                GAME_BLOCK_BREAK=        0x37,
                GAME_MAPCHUNK_BULK=      0x38,
                GAME_ENT_BOOM=           0x3C,
                GAME_ENT_NOISE=          0x3D,
                GAME_SOUND_EFFECT=       0x3E,
                GAME_GAME_CHANGE=        0x46,
                GAME_WEATHER=            0x47,
                GAME_KICK=               0xFF,
